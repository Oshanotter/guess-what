...
function installPrompt() {
    if (!isRunningStandalone()){
    	if (isiOS()){
    		...
    		var message = "<h1>Welcome to Guess What?!</h1><p>The experience is better with the App!</p><p>Download it by tapping the share button <img src='icons/general/share.png' style='display: inline; width: 1.5em;' alt='img-mail' class='invertable-image'/> below, then tap on 'Add to Home Screen'</p>"
